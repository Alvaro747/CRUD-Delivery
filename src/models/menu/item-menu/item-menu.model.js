 ...
 *          category:
 *            type: string
 *            description: Item Menu Category.
 *        example:
 *            id: ""
 *            name: "hamburger"
...
class ItemMenuModel extends BaseModel {
  constructor (args, dependencies) {
    ...
    this.status = { value: args.status || ItemMenuModel.statuses.active, type: this._types.object }
